		...
		<ul class="nav navbar-nav">
			...
			<li class="dropdown messages-menu">
				...
				<ul class="dropdown-menu">
					<li class="header"><?php echo $unread ?> unhandled messages</li>
					<li>
						...
						<ul class="menu">
							...
							for($loop = 0;$loop < $unread; $loop++){	
								...
								//TODO: setelah diquery, tulis semuanya satu2 disini :3
								'notificationUsername' => 'SECTION',
								'notificationText' => 'TESTING!',
								'notificationTime' => '1 year ago'		
								));
				...
				<ul class="dropdown-menu">
					...
					<li>
						...
						<ul class="menu">
							...
							<li><a href="#"> <i class="fa fa-warning danger"></i> Very long
									description here that may not fit into the page and may cause
									design problems
							</a></li>
							<li><a href="#"> <i class="fa fa-users warning"></i> 5 new
									members joined
							</a></li>

							<li><a href="#"> <i class="ion ion-ios7-cart success"></i> 25
									sales made
							</a></li>
							<li><a href="#"> <i class="ion ion-ios7-person danger"></i> You
			...
			<li class="dropdown user user-menu"><a href="#"
				...
				<ul class="dropdown-menu">
					<!-- User image -->
					<li class="user-header bg-light-blue"><img src="img/avatar3.png"
